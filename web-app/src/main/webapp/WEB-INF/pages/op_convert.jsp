...
<% request.setAttribute("page","convert");
   request.setAttribute("username",session.getAttribute("username"));
   request.setAttribute("corbaOk", com.pdfservice.util.CORBAClient.isAlive()); %>
<!DOCTYPE html><html lang="fr"><head>
<meta charset="UTF-8"><title>PDF vers Images - CORBA PDF</title>
...
<div class="main">
  <div class="topbar"><div>
    ...
    <div class="page-sub">Convertir chaque page en image PNG</div>
  </div></div>
  <div class="content">
    <c:if test="${not empty error}"><div class="alert alert-error">${error}</div></c:if>
    <div class="card" style="max-width:680px">
      <div class="card-title">🖼️ PDF vers Images</div>
      <form method="post" action="${pageContext.request.contextPath}/pdf/convert"
        ...
        <div class="form-group"><label>Résolution: <b id="dv">150</b> DPI</label>
  ...
  <p class="hint">72=rapide, 150=standard, 300=haute qualité</p>
</div>
<div class="alert alert-info" style="margin-bottom:0">Le résultat sera un fichier ZIP contenant une image PNG par page.</div>
