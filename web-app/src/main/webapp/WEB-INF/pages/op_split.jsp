...
<%
    request.setAttribute("currentPage", "split");
...
<head>
    <meta charset="UTF-8">
    <title>Découpage PDF - CORBA PDF Service</title>
    ...
    <div class="main-content">
        <div class="topbar">
            <div>
                ...
                <div class="page-sub">Extrayez une plage de pages de votre PDF</div>
            </div>
        </div>
        <div class="content-area">
            ...
            <div class="card op-form">
                <form method="post" action="${pageContext.request.contextPath}/pdf/split"
                    ...
                    <p class="hint">Le PDF résultant contiendra les pages de la page de début à la page de fin incluse.</p>
...
document.getElementById('opForm').addEventListener('submit',function(e){
    ...
    fetch(this.action,{method:'POST',body:fd}).then(r=>{
        if(r.ok)return r.blob().then(b=>{const u=URL.createObjectURL(b);const a=document.createElement('a');a.href=u;a.download='split.pdf';a.click();});
