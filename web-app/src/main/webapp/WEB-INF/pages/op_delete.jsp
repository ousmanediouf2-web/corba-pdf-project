...
<meta charset="UTF-8"><title>Suppression de pages - CORBA PDF</title>
...
<div class="main">
  <div class="topbar"><div>
    ...
    <div class="page-sub">Supprimer des pages indésirables</div>
  </div></div>
  <div class="content">
    <c:if test="${not empty error}"><div class="alert alert-error">${error}</div></c:if>
    <div class="card" style="max-width:680px">
      <div class="card-title">🗑️ Suppression de pages</div>
      <form method="post" action="${pageContext.request.contextPath}/pdf/delete"
        ...
        <div class="form-group"><label>Numéros de pages à supprimer <span style="color:red">*</span></label>
  <input type="text" name="pages" required placeholder="Ex: 2, 4, 6">
  <p class="hint">Ces pages seront supprimées du document résultant</p>
</div>
