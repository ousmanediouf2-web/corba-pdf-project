...
<meta charset="UTF-8"><title>Extraction de texte - CORBA PDF</title>
...
<div class="main">
  <div class="topbar"><div>
    ...
    <div class="page-sub">Extraire le contenu textuel du PDF</div>
  </div></div>
  <div class="content">
    <c:if test="${not empty error}"><div class="alert alert-error">${error}</div></c:if>
    <div class="card" style="max-width:680px">
      <div class="card-title">📝 Extraction de texte</div>
      <form method="post" action="${pageContext.request.contextPath}/pdf/text"
        ...
        <div class="alert alert-info" style="margin-bottom:0">Le texte extrait sera affiché directement sur la page suivante.</div>
